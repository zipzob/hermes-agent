...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    For forked checkouts, preserve local commit history while replaying any
    fork-only overlay on top of ``upstream/main`` and then force-syncing
    ...
    # Compare only the direction we need for this flow: origin behind upstream.
